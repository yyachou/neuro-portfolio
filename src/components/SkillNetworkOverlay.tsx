...
import { 
  Brain, Waves, ShieldCheck, FlaskConical, 
  GraduationCap, Scale, Zap, Activity 
} from 'lucide-react';
...
const EVIDENCE = [
  "8 Publications", "12 Oral Comms", "722 Citations", "H-index 4",
  "J Affect Disord", "tDCS / rTMS", "DLPFC + Cerebellum", "Qualitative TMS"
];
...
const ConnectionLines = () => {
  // We use static paths that approximate the layout. 
  // In a production app, you could use refs to calculate exact coordinates, 
  // but CSS-animated SVG paths are more performant for background overlays.
  return (
    ...
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden p-6 md:p-12">
      ...
      <div className="relative z-10 w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 items-center gap-8 h-full">
        ...
        <div className="lg:col-span-4 flex flex-col items-center justify-center relative py-12 lg:py-0">
          ...
          <div className="absolute w-64 h-64 border border-dashed border-white/5 rounded-full animate-orbit" style={{ animationDirection: 'reverse' }} />
          ...
          <div className="relative group">
            ...
            <div className="absolute -inset-8 border border-blue-400/10 rounded-full animate-pulse-ring" style={{ animationDelay: '1s' }} />
            
            <div className="relative w-24 h-24 md:w-32 md:h-32 rounded-full bg-black border-2 border-white/20 flex items-center justify-center backdrop-blur-3xl shadow-2xl">
